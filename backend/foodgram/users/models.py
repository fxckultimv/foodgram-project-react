...
class User(AbstractUser):
    ...
    first_name = models.CharField('Имя', blank=False, max_length=200)
    last_name = models.CharField('Фамилия', blank=False, max_length=200)
    username = models.CharField('Имя пользователя', max_length=200, validators=[username_validator])
